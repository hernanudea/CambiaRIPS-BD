...
public class ArchivoAM extends Rips {
	...
	public static ArrayList<ArchivoAM> arrayAM = new ArrayList<ArchivoAM>();
	public static String ruta;
	public static boolean error = false;
	public static boolean advertencia = false;

	public ArchivoAM(int numeroFactura, String codigoPrestador, String tipoIdentificacionUsuario, String numeroIdentificacionUsuario, Date fechaProcedimientoConsulta, String numeroAutorizacion, String codigoConsultaProcedimiento, String codigoDiagnosticoPrincipal, String codigoDiagnosticoRelacionado1, int numeroFactura2, String codigoPrestador2,
			...
			while (archivoLeer.ready()) {
				...
				if (codigoNuevo == null) {
					...
					if (codigoNuevo.equals("-1")) {
						advertencia = true;
						archivoAMGuardar.write(arreglo[0] + "," + arreglo[1] + "," + arreglo[2] + "," + arreglo[3] + "," + arreglo[4] + "," + arreglo[5] + "," + arreglo[6] + "," + arreglo[7] + "," + arreglo[8] + "," + arreglo[9] + "," + arreglo[10] + "," + arreglo[11] + "," + arreglo[12] + "," + arreglo[13] + "\r\n");
						Log.guardarIncidencia(1, "AM", lineaArchivo, arreglo[6], "No se debe procesar según la configuración del archivo de códigos");
					} else {
						advertencia = true;
						archivoAMGuardar.write(arreglo[0] + "," + arreglo[1] + "," + arreglo[2] + "," + arreglo[3] + "," + arreglo[4] + "," + codigoNuevo + "," + arreglo[6] + "," + arreglo[7] + "," + arreglo[8] + "," + arreglo[9] + "," + arreglo[10] + "," + arreglo[11] + "," + arreglo[12] + "," + arreglo[13] + "\r\n");
					}
				}
			}
			archivoLeer.close();
